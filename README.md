...
Имя | Роль в проекте
------------------|---------------------
Авраменко Денис | Концепция языка, парсер, документация
Лапенко Карина | Интерпретатор, объединение файлов, AST
...
>> Генеративный ИИ использовался на стороне парсера как советчик, знающий все про fparsec. Иногда уточнял у него, как сделать лучше, иногда сам костылил)
>> 
>> Так же использовался для написания тестов и раскидки принтов дебага (DebugParser). Помог разобраться с проектом на платформе dotnet

## Краткое описание
Язык основан на синтаксисе маркдауна, насоклько хватило фантазии

Более подробная спецификация находится в specification.md

Примеры программ можно найти в папке samples
...
Можно использовать, как `.txt`, так и `.md`. Можно прям из сэмплов взять: `dotnet run -- samples/factorial.md`
### Как код из сэмплов выглядит в обсидиане
#### Simple
<img src="images/simple.png" alt="simple" width="200"/>

#### Factorial
<img src="images/factorial.png" alt="Factorial" width="500"/>

#### If and functions
<img src="images/if_and_funcs.png" alt="If and funcs" width="500"/>
